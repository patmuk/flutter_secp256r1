...
let
  ...
  frb_source =
    if (desired_version == "v2.9.0") then
      pkgs.fetchFromGitHub
        {
          owner = "fzyzcjy";
          repo = "flutter_rust_bridge";
          rev = "f54a686dd48d8bbb145e86e15b9a1853458b8e93"; # hash of the commit
          hash = "sha256-pvKCiv7hUgetTXXp+NCs04Qo9xWaLUE2T1yHENhTGl4=";
          fetchSubmodules = true;
        }
    else if (desired_version == "v2.8.0") then
      pkgs.fetchFromGitHub
        {
          owner = "fzyzcjy";
          repo = "flutter_rust_bridge";
  ...
  frb_cargoHash =
    if (desired_version == "v2.9.0") then
      "sha256-efMA8VJaQlqClAmjJ3zIYLUfnuj62vEIBKsz0l3CWxA="
    else if (desired_version == "v2.8.0") then
      "sha256-zRiyLFDRqhi6TUt/UfWvgJ2hqWdUz8jxUCvN5RDp1Bk="
    else if (desired_version == "v2.7.0") then
      "sha256-4/Tmj0FFBLhGKbabE+kcoHqBX7rmlg3ps3oZ/hwuir8="
    else if (desired_version == "v2.5.0") then
      "sha256-dP1KuPQhJdXZNNLRqLoqnkJMpUm9U/KdcSVWOUqd7JA="
    else if (desired_version == "v2.4.0") then
